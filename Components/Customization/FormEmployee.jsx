...
const SocialMediaIcon = ({socialMedia,socialMediaItem, socialMediaSelected, setSocialMediaSelected}) => {
    ...
    return(
     <IconButton onClick={() => setSocialMediaSelected([...socialMediaSelected, {
      name: socialMediaItem, value: '', id: getRandomArbitrary(0,1000000)}])}>
...
const FormEmployee = () => {
  ...
  const deleteSocialMedia = (item) => {
              ...
              setForm({ ...form, socialMedia: socialMedia})
